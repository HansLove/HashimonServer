...
import { TEMPERAMENTS } from "@/modules/companion/domain/companion";
//Core verification — byte-identical with the browser client.
import { test } from "node:test";
import assert from "node:assert/strict";
import { sha256, doubleSha256 } from "@/modules/core/core/sha256";
import { Dna } from "@/modules/core/core/dna";
import {
  leadingZeroBits,
  hashShare,
  hashShareLegacy,
